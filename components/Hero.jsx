				...
				<div className="max-w-[1240px] w-full h-[100%] mx-auto p-2 flex justify-center items-center ">
					<div className="mt-[110px] md:mt-[50px]">
						...
						<p className="py-4 text-gray-600 max-w-[70%] m-auto">
							I&apos;m a full-stack developer who loves creating
							everything from intuitive front-end interfaces to
							robust back-end systems. My goal is to build
							software that truly makes a difference—helping
							businesses and individuals solve real-world
							problems, streamline processes, and achieve their
							goals through smart, impactful solutions.
						</p>
