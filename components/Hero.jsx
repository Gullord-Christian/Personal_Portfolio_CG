    ...
    <div>
      ...
      <div id="hero" className="w-full h-[80vh] text-center">
        <div className="max-w-[1240px] w-full h-[100%] mx-auto p-2 flex justify-center items-center ">
          <div className="mt-[110px] md:mt-[50px]">
            <h1 className="py-4 text-gray-800">Hi, I&apos;m Christian</h1>
            <h2 className="py-2 text-gray-800">
              Software <span className="text-[#008b8b]">Developer</span>
            </h2>
            <p className="py-4 text-gray-600 max-w-[70%] m-auto">
              I'm a full-stack developer who absolutely loves crafting
              full-stack web applications from scratch. My ultimate goal is to
              make a real difference by building applications that can make an
              impact in the real world and help businesses and individuals
              achieve their goals through innovative software solutions.
            </p>
